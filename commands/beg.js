...
module.exports = {
    ...
    async execute(bot, message, args) {
        ...
        let sentences = [
            `You went up to the almighty Winter and he gave you ${amount} coins so you would leave him alone. Nice!`,
            `You got ${amount} coins begging on the street. Guess it's your lucky day!`,
            `After begging 100 times, Winter finally appreciated your hard work and donated you ${amount} coins!`,
            `You tried to beg in Mystic's global chat and a fellow Staff gave you ${amount} coins just to leave.`,
            `You came to White House to ask Trump for money. He gave you ${amount} coins just to go away before security caught you.`
        ]
        let badsentences = [
        ...
        if (beg !== null && timeout - (Date.now() - beg) > 0) {
            ...
            message.channel.send(`You've already begged recently. Beg again in \`${time.minutes}m ${time.seconds}s\``)
        } else {
